...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 111);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 135);
is_safe = is_safe && !(hdr.udp.dst_port == 69);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 69);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 500);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 500);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 500);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 500);
is_safe = is_safe && !(hdr.udp.src_port == 4000);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 500);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.src_port == 137 && hdr.udp.dst_port == 137);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.src_port == 137 && hdr.udp.dst_port == 137);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 53);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.src_port == 7808);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 7787);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 2048);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 53);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 137);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 42);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 135);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 135);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.udp.dst_port == 41170);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.udp.dst_port == 53);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 1900);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.src_port == 2425 && hdr.udp.dst_port == 2425);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 1434);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 53);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 53);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.udp.dst_port == 2090);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.src_port == 67 && hdr.udp.dst_port == 68);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.udp.src_port == 53);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.udp.src_port == 53);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 1040);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 1040);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 1900);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.udp.dst_port == 1900);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.udp.dst_port == 53);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 110);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 2401);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 2401);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 1655);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 1655);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 143);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 3535);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 3535);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 110);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 554);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 3389);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 119);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 119);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 3000);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 5050);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 5050);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 5050);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 5050);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 5050);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 5050);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 5050);
is_safe = is_safe && !(hdr.tcp.dst_port == 5101);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 5050);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 5050);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 5100);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 5100);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 179);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 548);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 873);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 81);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 2401);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 4711);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 143);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 110);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 53);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 139);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 445);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 119);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 143);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 143);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 20034);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 22222);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 22222);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 22222);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 23432);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 23432);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 2000);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 63536);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 42);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 139);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 139);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 139);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 139);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 143);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 3632);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 1020);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 1020);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 143);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 143);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 143);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 143);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 119);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 5880);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 5880);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.src_port == 5880);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 6101);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 1863);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 139);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 139);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 79);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 53);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 31337);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 137);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 42);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 515);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 617);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 617);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 5001);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 617);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 617);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 12080);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 84);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
...
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 1039);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 58455);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 25);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 10991);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 80);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 25);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
...
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 23);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 25);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 488);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 488);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 488);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 488);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 1433);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 1720);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 1720);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 4043);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
...
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 900);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 25);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
...
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 4786);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 4786);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 4786);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 4786);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
...
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.tcp.src_port == 445);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
is_safe = is_safe && !(hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 445);
...
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 21);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 9080);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 9080);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 443);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 443);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 8291);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 9251);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.tcp.src_port == 445);
...
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 32764);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.src_port == 32764);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 32764);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 32764);
is_safe = is_safe && !(hdr.ipv4.src == 0xc0a83803 && hdr.ipv4.dst != 0xc0a83803 && hdr.tcp.dst_port == 443);
is_safe = is_safe && !(hdr.ipv4.src != 0xc0a83803 && hdr.ipv4.dst == 0xc0a83803 && hdr.tcp.dst_port == 23);
    }
